...
void Serveur::readServeur()
{
    ...
    QStringList list=message.split("\r\n");
        ...
        {
            if(msg.contains(QRegExp(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ PRIVMSG ([a-zA-Z0-9\\#]+) :(.+)")))
            {
                QRegExp reg(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ PRIVMSG ([a-zA-Z0-9\\#]+) :(.+)");
                QString msg2=msg;
                    ecrire(msg.replace(reg,"\\2 <b>&lt;\\1&gt;</b> \\3"),"",msg2.replace(reg,"\\2 <\\1> \\3"));
            }
            else if(msg.contains(QRegExp(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ JOIN ([a-zA-Z0-9\\#]+)")))
            {
                QRegExp reg(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ JOIN ([a-zA-Z0-9\\#]+)");
                QString msg2=msg;
                ecrire(msg.replace(reg,"\\2 <i>-> \\1 join \\2</i><br />"),"",msg2.replace(reg,"-> \\1 join \\2"));
                updateUsersList(msg.replace(reg,"\\2"));
            }
            else if(msg.contains(QRegExp(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ PART ([a-zA-Z0-9\\#]+)")))
            {
                QRegExp reg(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ PART ([a-zA-Z0-9\\#]+) :(.+)");
                QString msg2=msg;
                ecrire(msg.replace(reg,"\\2 <i>-> \\1 quit \\2 (\\3)</i><br />"),"",msg2.replace(reg,"-> \\1 quit \\2"));
                updateUsersList(msg.replace(reg,"\\2"));
            }
            else if(msg.contains(QRegExp(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ QUIT (.+)")))
            {
                QRegExp reg(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ QUIT (.+)");
                QString msg2=msg;
                ecrire(msg.replace(reg,"\\2 <i>-> \\1 quit this server (\\2)</i><br />"),"",msg2.replace(reg,"-> \\1 left"));
                updateUsersList(msg.replace(reg,"\\2"));
            }
            else if(msg.contains(QRegExp(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ NICK :(.+)")))
            {
                QRegExp reg(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ NICK :(.+)");
                QString msg2=msg;
                ecrire(msg.replace(reg,"<i>\\1 is now called \\2</i><br />"),"",msg2.replace(reg,"-> \\1 is now called \\2"));
                updateUsersList(currentChan);
            }
            else if(msg.contains(QRegExp(":([a-zA-Z0-9\\_-]+)\\![a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ KICK ([a-zA-Z0-9\\#]+) ([a-zA-Z0-9\\_-]+) :(.+)")))
            { 
                QRegExp reg(":([a-zA-Z0-9\\_-]+)\\!~[a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ KICK ([a-zA-Z0-9\\#]+) ([a-zA-Z0-9\\_-]+) :(.+)");
                QString msg2=msg;
                ecrire(msg.replace(reg,"\\2 <i>-> \\1 kicked \\3 (\\4)</i><br />"),"",msg2.replace(reg,"-> \\1 quit \\3"));
                updateUsersList(msg.replace(reg,"\\2"));
            }
            else if(msg.contains(QRegExp(":([a-zA-Z0-9\\_-]+)\\![a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ NOTICE ([a-zA-Z0-9\\_-]+) :(.+)")))
            {
                if(conversations.contains(currentChan))
                {
                    QRegExp reg(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ NOTICE [a-zA-Z0-9\\_-]+ :(.+)");
                    ecrire(msg.replace(reg,"<b>[NOTICE]</b> <i>\\1</i> : \\2 <br />"),currentChan);
                }
                else if(currentChan==serveur)
                {
                    QRegExp reg(":([a-zA-Z0-9\\_-]+)\\![~a-zA-Z0-9\\_-]+@[a-zA-Z0-9\\/\\:.-]+ NOTICE [a-zA-Z0-9\\_-]+ :(.+)");
                    ecrire(msg.replace(reg,"<b>[NOTICE]</b> <i>\\1</i> : \\2 <br />"));
                }
            }
