...
void StatisticsPage::updateStatistics()
{
    ...
    QString pawrate = QString::number(pPawrate2);
    ...
    {
        ui->heightBox->setText("<b><font color=\"red\">" + height + "</font></b>");
    } else {
    ...
    {
        ui->cBox->setText("<b><font color=\"red\">" + phase + "</font></b>");
    } else {
    ...
    {
        ui->localBox->setText("<b><font color=\"red\">" + Qlpawrate + "</font></b>");
    } else {
    ...
    {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " RIN" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " RIN" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " RIN");
    }
